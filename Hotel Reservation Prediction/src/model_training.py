...
class ModelTraining:
    ...
    def __init__(self, train_path, test_path, model_output_path):
        ...
        self.parmas_dist = LIGHTGM_PARAMS
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            random_search = RandomizedSearchCV(
                ...
                param_distributions = self.parmas_dist,
            ...
            logger.info(f'Best estimator are: {best_params}')
    ...
    def run(self):
        try:
            with mlflow.start_run():
                logger.info("Starting our modle training pipeline")
                ...
                logger.info("Model training succcessfully completed")
        except Exception as e:
