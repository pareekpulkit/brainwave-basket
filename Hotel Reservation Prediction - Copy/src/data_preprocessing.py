...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            df.drop(labels=['Unnamed: 0', 'Booking_ID'], axis=1, inplace=True)
            ...
            for colum in skewness[skewness_threshold<skewness].index:
            ...
            raise CustomException('Error while preprocessig data : ', e)
    ...
    def select_features(self, df):
        try:
            ...
            top_features_importance_df = feature_importance_df.sort_values('importance', ascending=False)
    ...
    def save_data(self, df, file_path):
        try:
            logger.info("Saving our data in procesed folder")
    ...
    def process(self):
        try:
            ...
            logger.info("Data Procesing completed successfully")
